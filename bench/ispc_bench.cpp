...
BENCHMARK(BM_ISPC_MatDot_10x10)->UseRealTime();
BENCHMARK(BM_ISPC_MatDot_100x100)->UseRealTime();
BENCHMARK(BM_ISPC_MatDot_1000x1000)->UseRealTime();
BENCHMARK(BM_ISPC_MatAdd_10x10)->UseRealTime();
BENCHMARK(BM_ISPC_MatAdd_100x100)->UseRealTime();
BENCHMARK(BM_ISPC_MatAdd_1000x1000)->UseRealTime();
BENCHMARK(BM_ISPC_MatMul_10x10)->UseRealTime();
BENCHMARK(BM_ISPC_MatMul_100x100)->UseRealTime();
BENCHMARK(BM_ISPC_MatMul_1000x1000)->UseRealTime();
