...
// gru forward
BENCHMARK(BM_ISPC_GRU_Forward_10x10_b1);
BENCHMARK(BM_ISPC_GRU_Forward_10x10_b8);
BENCHMARK(BM_ISPC_GRU_Forward_10x10_b16);
BENCHMARK(BM_ISPC_GRU_Forward_10x10_b32);
BENCHMARK(BM_ISPC_GRU_Forward_10x10_b64);
BENCHMARK(BM_ISPC_GRU_Forward_10x10_b128);
BENCHMARK(BM_ISPC_GRU_Forward_100x100_b1);
BENCHMARK(BM_ISPC_GRU_Forward_100x100_b8);
BENCHMARK(BM_ISPC_GRU_Forward_100x100_b16);
BENCHMARK(BM_ISPC_GRU_Forward_100x100_b32);
BENCHMARK(BM_ISPC_GRU_Forward_100x100_b64);
BENCHMARK(BM_ISPC_GRU_Forward_100x100_b128)
