...
/* GRU - 10x10 */
static void BM_OMP_GRU_Forward_10x10_b1(benchmark::State& state) {
    GRU gru(10, 10);
    Matrix input_x(10, 1);
    Matrix h(10, 1);
...
static void BM_OMP_GRU_Forward_10x10_b8(benchmark::State& state) {
    GRU gru(10, 10);
    Matrix input_x(10, 8);
    Matrix h(10, 8);
...
static void BM_OMP_GRU_Forward_10x10_b16(benchmark::State& state) {
    GRU gru(10, 10);
...
static void BM_OMP_GRU_Forward_10x10_b32(benchmark::State& state) {
    GRU gru(10, 10);
...
static void BM_OMP_GRU_Forward_10x10_b64(benchmark::State& state) {
    GRU gru(10, 10);
...
static void BM_OMP_GRU_Forward_10x10_b128(benchmark::State& state) {
    GRU gru(10, 10);
...
/* GRU - 100x100 */
static void BM_OMP_GRU_Forward_100x100_b1(benchmark::State& state) {
    GRU gru(100, 100);
...
static void BM_OMP_GRU_Forward_100x100_b8(benchmark::State& state) {
    GRU gru(100, 100);
...
static void BM_OMP_GRU_Forward_100x100_b16(benchmark::State& state) {
    GRU gru(100, 100);
...
static void BM_OMP_GRU_Forward_100x100_b32(benchmark::State& state) {
    GRU gru(100, 100);
...
static void BM_OMP_GRU_Forward_100x100_b64(benchmark::State& state) {
    GRU gru(100, 100);
...
static void BM_OMP_GRU_Forward_100x100_b128(benchmark::State& state) {
    GRU gru(100, 100);
...
BENCHMARK(BM_OMP_GRU_Forward_10x10_b1)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_10x10_b8)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_10x10_b16)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_10x10_b32)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_10x10_b64)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_10x10_b128)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_100x100_b1)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_100x100_b8)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_100x100_b16)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_100x100_b32)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_100x100_b64)->UseRealTime();
BENCHMARK(BM_OMP_GRU_Forward_100x100_b128)->UseRealTime();
